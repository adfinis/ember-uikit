/*! For license information please see chunk.404.2fc80a1aab0452db4fdf.js.LICENSE.txt */
...
i||e instanceof Document?i&&(o.mostRecentlyFocusedNode=e):(t.stopImmediatePropagation(),T(o.mostRecentlyFocusedNode||w()))},_=function(t){if(function(t){return"Escape"===t.key||"Esc"===t.key||27===t.keyCode}(t)&&!1!==k(s.escapeDeactivates,t))return t.preventDefault(),void i.deactivate();(function(t){return"Tab"===t.key||9===t.keyCode})(t)&&function(t){var e=$(t)
S()
var i=null
...
i&&(t.preventDefault(),T(i))}(t)},A=function(t){if(!k(s.clickOutsideDeactivates,t)){var e=$(t)
c(e)||k(s.allowOutsideClick,t)||(t.preventDefault(),t.stopImmediatePropagation())}},O=function(){if(o.active)return b.activateTrap(i),o.delayInitialFocusTimer=s.delayInitialFocus?y((function(){T(w())})):T(w()),n.addEventListener("focusin",C,!0),n.addEventListener("mousedown",E,{capture:!0,passive:!1}),n.addEventListener("touchstart",E,{capture:!0,passive:!1}),n.addEventListener("click",A,{capture:!0,passive:!1}),n.addEventListener("keydown",_,{capture:!0,passive:!1}),i},P=function(){if(o.active)return n.removeEventListener("focusin",C,!0),n.removeEventListener("mousedown",E,!0),n.removeEventListener("touchstart",E,!0),n.removeEventListener("click",A,!0),n.removeEventListener("keydown",_,!0),i}
...
var a=function(){s&&S(),O(),i&&i()}
return s?(s(o.containers.concat()).then(a,a),this):(a(),this)},deactivate:function(t){if(!o.active)return this
clearTimeout(o.delayInitialFocusTimer),o.delayInitialFocusTimer=void 0,P(),o.active=!1,o.paused=!1,b.deactivateTrap(i)
...
return a&&s?(s(I(o.nodeFocusedBeforeActivation)).then(l,l),this):(l(),this)},pause:function(){return o.paused||!o.active||(o.paused=!0,P()),this},unpause:function(){return o.paused&&o.active?(o.paused=!1,S(),O(),this):this},updateContainerElements:function(t){var e=[].concat(t).filter(Boolean)
...
return!isNaN(e)&&e}function P(t){return parseFloat(t)||0}function D(t){return B(t)[0]}function B(t){return t&&(x(t)?[t]:Array.from(t).filter(x))||[]}function N(t){var e
if(b(t))return t
...
return!i.has(n)&&i.add(n)}))}function W(t,e,i){return void 0===e&&(e=0),void 0===i&&(i=1),Math.min(Math.max(O(t)||0,e),i)}function R(){}function q(){for(var t=arguments.length,e=new Array(t),i=0;i<t;i++)e[i]=arguments[i]
...
for(const i in t)t=t[i]<e[i]?U(t,i,e[i]):t
return t}}
function X(t,e,i,n){void 0===i&&(i=0),void 0===n&&(n=!1),e=B(e)
const{length:s}=e
return s?(t=E(t)?O(t):"next"===t?i+1:"previous"===t?i-1:e.indexOf(D(t)),n?W(t,0,s-1):(t%=s)<0?t+s:t):-1}function Z(t){const e=Object.create(null)
...
for(const n of B(t))g(i)&&(i=i.call(n,K(n,e))),null===i?tt(n,e):n.setAttribute(e,i)}}function Q(t,e){return B(t).some((t=>t.hasAttribute(e)))}function tt(t,e){const i=B(t)
...
function nt(t){return B(t).some((t=>it[t.tagName.toLowerCase()]))}function st(t){return B(t).some((t=>t.offsetWidth||t.offsetHeight||t.getClientRects().length))}const ot="input,select,textarea,button"
function rt(t){return B(t).some((t=>dt(t,ot)))}const at=ot+",a[href],[tabindex]"
function lt(t){return dt(t,at)}function ht(t){var e
return null==(e=D(t))?void 0:e.parentElement}function ct(t,e){return B(t).filter((t=>dt(t,e)))}function dt(t,e){return B(t).some((t=>t.matches(e)))}function ut(t,e){return k(t)?t.closest(h(e,">")?e.slice(1):e):B(t).map((t=>ut(t,e))).filter(Boolean)}function ft(t,e){return T(e)?!!ut(t,e):D(e).contains(D(t))}function pt(t,e){const i=[]
for(;t=ht(t);)e&&!dt(t,e)||i.push(t)
return i}function mt(t,e){const i=(t=D(t))?B(t.children):[]
return e?ct(i,e):i}function gt(t,e){return e?B(t).indexOf(D(e)):mt(ht(t)).indexOf(t)}function vt(t,e){return bt(t,$t(t,e))}function wt(t,e){return yt(t,$t(t,e))}function bt(t,e){return D(It(t,e,"querySelector"))}function yt(t,e){return B(It(t,e,"querySelectorAll"))}const xt=/(^|[^\\],)\s*[!>+~-]/,kt=Z((t=>t.match(xt)))
...
ie(t,i,"remove")}function Kt(t,e){K(t,"class",(t=>(t||"").replace(new RegExp("\\b"+e+"\\b\\s?","g"),"")))}function Qt(t){(arguments.length<=1?void 0:arguments[1])&&Jt(t,arguments.length<=1?void 0:arguments[1]),(arguments.length<=2?void 0:arguments[2])&&Zt(t,arguments.length<=2?void 0:arguments[2])}function te(t,e){return[e]=ne(e),!!e&&B(t).some((t=>t.classList.contains(e)))}function ee(t,e,i){const n=ne(e)
_(i)||(i=!!i)
for(const s of B(t))for(const t of n)s.classList.toggle(t,i)}function ie(t,e,i){e=e.reduce(((t,e)=>t.concat(ne(e))),[])
for(const n of B(t))n.classList[i](...e)}function ne(t){return String(t).split(/\s|,/).filter(Boolean)}const se={start:function(t,e,i,n){return void 0===i&&(i=400),void 0===n&&(n="linear"),i=Math.round(i),Promise.all(B(t).map((t=>new Promise(((s,o)=>{for(const i in e){const e=Yt(t,i)
""===e&&Yt(t,i,e)}const r=setTimeout((()=>Bt(t,"transitionend")),i)
Dt(t,"transitionend transitioncanceled",(e=>{let{type:i}=e
clearTimeout(r),Jt(t,"uk-transition"),Yt(t,{transitionProperty:"",transitionDuration:"",transitionTimingFunction:""}),"transitioncanceled"===i?o():s(t)}),{self:!0}),Zt(t,"uk-transition"),Yt(t,{transitionProperty:Object.keys(e).map(Xt).join(","),transitionDuration:i+"ms",transitionTimingFunction:n,...e})})))))},async stop(t){Bt(t,"transitionend"),await Promise.resolve()},async cancel(t){Bt(t,"transitioncanceled"),await Promise.resolve()},inProgress:t=>te(t,"uk-transition")},oe="uk-animation-"
function re(t,e,i,n,s){return void 0===i&&(i=200),Promise.all(B(t).map((t=>new Promise(((o,r)=>{Bt(t,"animationcanceled")
const a=setTimeout((()=>Bt(t,"animationend")),i)
Dt(t,"animationend animationcanceled",(e=>{let{type:i}=e
clearTimeout(a),"animationcanceled"===i?r():o(t),Yt(t,"animationDuration",""),Kt(t,"uk-animation-\\S*")}),{self:!0}),Yt(t,"animationDuration",i+"ms"),Zt(t,e,oe+(s?"leave":"enter")),h(e,oe)&&(n&&Zt(t,"uk-transform-origin-"+n),s&&Zt(t,"uk-animation-reverse"))})))))}const ae=new RegExp("uk-animation-(enter|leave)"),le={in:re,out:(t,e,i,n)=>re(t,e,i,n,!0),inProgress:t=>ae.test(K(t,"class")),cancel(t){Bt(t,"animationcanceled")}},he={width:["left","right"],height:["top","bottom"]}
...
if(t){const{scrollY:e,scrollX:n}=N(t),s={height:e,width:n}
...
for(;t=t.offsetParent;)if(e[0]+=t.offsetTop+P(Yt(t,"borderTopWidth")),e[1]+=t.offsetLeft+P(Yt(t,"borderLeftWidth")),"fixed"===Yt(t,"position")){const i=N(t)
...
return o&&(s=function(t,e){return t*P(e)/100}("vh"===o?pe(N(i)):"vw"===o?me(N(i)):n?i["offset"+a(e)]:ce(i)[e],s)),t+P(s)}),0):P(t)}const ye=/-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g,xe=Z((t=>t.toString().replace(/\s/g,"").match(ye)||[])),ke=/(?:v[hw]|%)$/,$e=Z((t=>(t.match(ke)||[])[0]))
function Se(t){"loading"===document.readyState?Dt(document,"DOMContentLoaded",t):t()}function Te(t,e){var i
return(null==t||null==(i=t.tagName)?void 0:i.toLowerCase())===e.toLowerCase()}function Ie(t){return(t=We(t)).innerHTML="",t}function Ee(t,e){return _(e)?We(t).innerHTML:_e(Ie(t),e)}const Ce=Pe("prepend"),_e=Pe("append"),Ae=Pe("before"),Oe=Pe("after")
function Pe(t){return function(e,i){var n
const s=B(T(i)?Le(i):i)
return null==(n=We(e))||n[t](...s),je(s)}}function De(t){B(t).forEach((t=>t.remove()))}function Be(t,e){for(e=D(Ae(t,e));e.firstChild;)e=e.firstChild
return _e(e,t),e}function Ne(t,e){return B(B(t).map((t=>t.hasChildNodes()?Be(B(t.childNodes),e):_e(t,e))))}function Me(t){B(t).map(ht).filter(((t,e,i)=>i.indexOf(t)===e)).forEach((t=>t.replaceWith(...t.childNodes)))}const ze=/^\s*<(\w+|!)[^>]*>/,Fe=/^<(\w+)\s*\/?>(?:<\/\1>)?$/
...
for(const o of B(t))s.observe(o)
...
for(const t of ci)t()}}
Ot(window,"load resize",e),Ot(document,"loadedmetadata load",e,!0)}(),ci.add(e),{disconnect(){ci.delete(e)}})}let ci
function di(t,e,i){return ui(MutationObserver,t,e,i)}function ui(t,e,i,n){const s=new t(i)
for(const o of B(e))s.observe(o,n)
return s}const fi={}
...
let _i=0
function Ai(t,e,i){return void 0===e&&(e=0),void 0===i&&(i=0),!!st(t)&&q(...Di(t).map((t=>{const{top:n,left:s,bottom:o,right:r}=Bi(t)
return{top:n-e,left:s-i,bottom:o+e,right:r+i}})).concat(de(t)))}function Oi(t,e){let{offset:i=0}=void 0===e?{}:e
const n=st(t)?Di(t):[]
return n.reduce(((e,s,o)=>{const{scrollTop:r,scrollHeight:a,offsetHeight:l}=s,h=Bi(s),c=a-h.height,{height:d,top:u}=n[o-1]?Bi(n[o-1]):de(t)
...
const[n]=Di(t,/auto|scroll/,!0),{scrollHeight:s,scrollTop:o}=n,{height:r}=Bi(n),a=s-r,l=fe(t)[0]-fe(n)[0],h=Math.max(0,l-r+e)
return W((o-h)/(Math.min(a,l+t.offsetHeight-i)-h))}function Di(t,e,i){void 0===e&&(e=/auto|scroll|hidden|clip/),void 0===i&&(i=!1)
const n=Ni(t)
let s=pt(t).reverse()
s=s.slice(s.indexOf(n)+1)
const o=u(s,(t=>"fixed"===Yt(t,"position")))
return~o&&(s=s.slice(o)),[n].concat(s.filter((t=>e.test(Yt(t,"overflow"))&&(!i||t.scrollHeight>Bi(t).height)))).reverse()}function Bi(t){const e=N(t),{document:{documentElement:i}}=e
let n=t===Ni(t)?e:t
...
return o}function Ni(t){return N(t).document.scrollingElement}const Mi=[["width","x","left","right"],["height","y","top","bottom"]]
...
let a=n
for(const[l,[h,,c,d]]of Object.entries(Mi)){const u=Wi(e[l],o,s,l)
...
f=W(W(n[c],u[c],u[d]-n[h]),t[c]-n[h]+s[l],t[d]-s[l])-n[c]}a=ji(a,f,l)}return a}function Li(t,e,i){let{attach:n,offset:s}={attach:{element:["left","top"],target:["left","top"],...i.attach},offset:[0,0],...i},o=de(t)
for(const[r,[a,,l,h]]of Object.entries(Mi)){const t=n.target[r]===n.element[r]?Bi(e[r]):de(e[r])
o=ji(o,t[l]-o[l]+Hi(n.target[r],h,t[a])-Hi(n.element[r],h,o[a])+ +s[r],r)}return o}function ji(t,e,i){const[,n,s,o]=Mi[i],r={...t}
return r[s]=t[n]=t[s]+e,r[o]+=e,r}function Hi(t,e,i){return"center"===t?i/2:t===e?i:0}function Wi(t,e,i,n){let s=qi(...Di(t).map(Bi))
return e&&(s[Mi[n][2]]+=e,s[Mi[n][3]]-=e),i&&(s=qi(s,de(f(i)?i[n]:i))),s}function Ri(t,e,i){const[n,,s,o]=Mi[i],[r]=Di(t),l=Bi(r)
...
if(~i)return Mi[1-e][i%2+2]}}function Zi(t,e){return(t=[...t])[e]*=-1,t}var Ji=Object.freeze({__proto__:null,ajax:Vt,getImage:Ut,Transition:se,Animation:le,attr:K,hasAttr:Q,removeAttr:tt,data:et,addClass:Zt,removeClass:Jt,removeClasses:Kt,replaceClass:Qt,hasClass:te,toggleClass:ee,dimensions:ce,offset:de,position:ue,offsetPosition:fe,height:pe,width:me,boxModelAdjust:ve,flipPosition:we,toPx:be,ready:Se,isTag:Te,empty:Ie,html:Ee,prepend:Ce,append:_e,before:Ae,after:Oe,remove:De,wrapAll:Be,wrapInner:Ne,unwrap:Me,fragment:Le,apply:He,$:We,$$:Re,inBrowser:Ve,isRtl:Ue,hasTouch:Ge,pointerDown:Xe,pointerMove:Ze,pointerUp:Je,pointerEnter:Ke,pointerLeave:Qe,pointerCancel:ti,on:Ot,off:Pt,once:Dt,trigger:Bt,createEvent:Nt,toEventTargets:Wt,isTouch:Rt,getEventPos:qt,fastdom:ei,isVoidElement:nt,isVisible:st,selInput:ot,isInput:rt,selFocusable:at,isFocusable:lt,parent:ht,filter:ct,matches:dt,closest:ut,within:ft,parents:pt,children:mt,index:gt,hasOwn:i,hyphenate:s,camelize:r,ucfirst:a,startsWith:h,endsWith:c,includes:d,findIndex:u,isArray:f,toArray:p,assign:m,isFunction:g,isObject:v,isPlainObject:w,isWindow:b,isDocument:y,isNode:x,isElement:k,isBoolean:S,isString:T,isNumber:I,isNumeric:E,isEmpty:C,isUndefined:_,toBoolean:A,toNumber:O,toFloat:P,toNode:D,toNodes:B,toWindow:N,isEqual:M,swap:z,last:F,each:L,sortBy:j,uniqueBy:H,clamp:W,noop:R,intersectRect:q,pointInRect:V,Dimensions:Y,getIndex:X,memoize:Z,Deferred:J,MouseTracker:ri,observeIntersection:ai,observeResize:hi,observeMutation:di,mergeOptions:vi,parseOptions:wi,play:bi,pause:yi,mute:xi,isVideo:ki,positionAt:zi,query:vt,queryAll:wt,find:bt,findAll:yt,escape:At,css:Yt,propName:Xt,isInView:Ai,scrollIntoView:Oi,scrolledOver:Pi,scrollParents:Di,offsetViewport:Bi})
...
s=g(s)?s.call(t):s||t.$el,f(s)?s.forEach((n=>tn(t,{...e,el:n},i))):!s||h&&!h.call(t)||t._events.push(Ot(s,n,l?T(l)?l:l.call(t):null,T(o)?t[o]:o.bind(t),{passive:a,capture:r,self:c}))}function en(t,e){return t.every((t=>!t||!i(t,e)))}function nn(t,e){return t===Boolean?A(e):t===Number?O(e):"list"===t?function(t){return f(t)?t:T(t)?t.split(/,(?![^(]*\))/).map((t=>E(t)?O(t):A(t.trim()))):[t]}(e):t?t(e):e}function sn(t){const{$name:e,$options:i,$props:n}=t,{attrs:o,props:a,el:l}=i
if(!a||!1===o)return
...
rn.util=Ji,rn.data="__uikit__",rn.prefix="uk-",rn.options={},rn.version="3.15.5",function(t){const e=t.data
let i
...
He(t,(t=>n(t[e],i)))},Object.defineProperty(t,"container",{get:()=>i||document.body,set(t){i=We(t)}})}(rn),function(t){function e(t){for(const{read:e,write:i,events:n=[]}of this.$options.update){if(!t.has("update")&&!n.some((e=>t.has(e))))continue
let s
...
var an={connected(){!te(this.$el,this.$name)&&Zt(this.$el,this.$name)}},ln={data:{preload:5},methods:{lazyload(t,e){void 0===t&&(t=this.$el),void 0===e&&(e=this.$el),this.registerObserver(ai(t,((t,i)=>{for(const n of B(g(e)?e():e))Re('[loading="lazy"]',n).slice(0,this.preload-1).forEach((t=>tt(t,"loading")))
...
return["slide","reveal"].some((t=>h(e[0],t)))}},methods:{toggleElement(t,e,i){return new Promise((n=>Promise.all(B(t).map((t=>{const n=S(e)?e:!this.isToggled(t)
...
Zt(t,o),Bt(t,n?"show":"hide",[this])
const r=()=>{Jt(t,o),Bt(t,n?"shown":"hidden",[this])}
return s?s.then(r,(()=>(Jt(t,o),Promise.reject()))):r()}))).then(n,R)))},isToggled(t){return void 0===t&&(t=this.$el),[t]=B(t),!!te(t,this.clsEnter)||!te(t,this.clsLeave)&&(this.cls?te(t,this.cls.split(" ")[0]):st(t))},_toggle(t,e){if(!t)return
let i
e=Boolean(e),this.cls?(i=d(this.cls," ")||e!==te(t,this.cls),i&&ee(t,this.cls,d(this.cls," ")?void 0:e)):(i=e===t.hidden,i&&(t.hidden=!e)),Re("[autofocus]",t).some((t=>st(t)?t.focus()||!0:t.blur())),i&&Bt(t,"toggled",[e,this])}}}
...
return this.items.map((t=>We(e,t)))},contents:{get(t){let{content:e}=t
return this.items.map((t=>We(e,t)))},watch(t){for(const e of t)pn(e,!te(this.items.find((t=>ft(e,t))),this.clsOpen))},immediate:!0}},connected(){this.lazyload()},events:[{name:"click",delegate(){return this.targets+" "+this.$props.toggle},handler(t){t.preventDefault(),this.toggle(gt(this.toggles,t.current))}}],methods:{toggle(t,e){let i=[this.items[X(t,this.items)]]
const n=ct(this.items,"."+this.clsOpen)
if(this.multiple||d(n,i[0])||(i=i.concat(n)),this.collapsible||!(n.length<2)||ct(i,":not(."+this.clsOpen+")").length)for(const s of i)this.toggleElement(s,!te(s,this.clsOpen),((t,i)=>{if(ee(t,this.clsOpen,i),K(We(this.$props.toggle,t),"aria-expanded",i),!1!==e&&this.animation)return mn(t,i,this).then((()=>{if(i){const e=We(this.$props.toggle,t)
requestAnimationFrame((()=>{Ai(e)||Oi(e,{offset:this.offset})}))}}),R)
pn(We(this.content,t),!i)}))}}}
function pn(t,e){t&&(t.hidden=e)}async function mn(t,e,i){var n
let{content:s,duration:o,velocity:r,transition:a}=i
s=(null==(n=t._wrapper)?void 0:n.firstElementChild)||We(s,t),t._wrapper||(t._wrapper=Be(s,"<div>"))
const l=t._wrapper
...
return!0===e&&this.$container||e&&We(e)}}},$n={props:{pos:String,offset:null,flip:Boolean,shift:Boolean,inset:Boolean},data:{pos:"bottom-"+(Ue?"right":"left"),offset:!1,flip:!0,shift:!0,inset:!1},connected(){this.pos=this.$props.pos.split("-").concat("center").slice(0,2),[this.dir,this.align]=this.pos,this.axis=d(["top","bottom"],this.dir)?"y":"x"},methods:{positionAt(t,e,i){let n=[this.getPositionOffset(t),this.getShiftOffset(t)]
...
return We(i,e)},transitionElement(){return this.panel},bgClose(t){let{bgClose:e}=t
return e&&this.panel}},beforeDisconnect(){d(Sn,this)&&this.toggleElement(this.$el,!1,!1)},events:[{name:"click",delegate(){return this.selClose},handler(t){t.preventDefault(),this.hide()}},{name:"toggle",self:!0,handler(t){t.defaultPrevented||(t.preventDefault(),this.isToggled()===d(Sn,this)&&this.toggle())}},{name:"beforeshow",self:!0,handler(t){if(d(Sn,this))return!1
!this.stack&&Sn.length?(Promise.all(Sn.map((t=>t.hide()))).then(this.show),t.preventDefault()):Sn.push(this)}},{name:"show",self:!0,handler(){Dt(this.$el,"hide",Ot(document,"focusin",(t=>{F(Sn)!==this||ft(t.target,this.$el)||this.$el.focus()}))),this.overlay&&(Dt(this.$el,"hidden",En(this.$el),{self:!0}),Dt(this.$el,"hidden",An(),{self:!0})),this.stack&&Yt(this.$el,"zIndex",P(Yt(this.$el,"zIndex"))+Sn.length),Zt(document.documentElement,this.clsPage),this.bgClose&&Dt(this.$el,"hide",Ot(document,Xe,(t=>{let{target:e}=t
...
const t=()=>this.$emit(),e=[Ot(document,Xe,(t=>{let{target:e}=t
return!ft(e,this.$el)&&Dt(document,Je+" "+ti+" scroll",(t=>{let{defaultPrevented:i,type:n,target:s}=t
i||n!==Je||e!==s||this.targetEl&&ft(e,this.targetEl)||this.hide(!1)}),!0)})),Ot(document,"keydown",(t=>{27===t.keyCode&&this.hide(!1)})),Ot(window,"resize",t),(()=>{const e=hi(Di(this.$el).concat(this.target),t)
return()=>e.disconnect()})(),...this.autoUpdate?[Ot([document,Di(this.$el)],"scroll",t,{passive:!0})]:[],...this.bgScroll?[]:[En(this.$el),An()]]
...
const t=this.target.map((t=>Bi(Di(t)[0]))),e=this.getViewportOffset(this.$el),i=[[0,["x","width","left","right"]],[1,["y","height","top","bottom"]]]
...
o!==r&&(e[s]=r)},events:[{name:"change",handler(){this.$emit()}},{name:"reset",el(){return ut(this.$el,"form")},handler(){this.$emit()}}]},Dn={mixins:[bn],props:{margin:String,firstColumn:Boolean},data:{margin:"uk-margin-small-top",firstColumn:"uk-first-column"},resizeTargets(){return[this.$el,...p(this.$el.children)]},connected(){this.registerObserver(di(this.$el,(()=>this.$reset()),{childList:!0}))},update:{read(){const t=Bn(this.$el.children)
return{rows:t,columns:Nn(t)}},write(t){let{columns:e,rows:i}=t
for(const n of i)for(const t of n)ee(t,this.margin,i[0]!==n),ee(t,this.firstColumn,e[0].includes(t))},events:["resize"]}}
function Bn(t){return Mn(t,"top","bottom")}function Nn(t){const e=[]
for(const i of t){const t=Mn(i,"left","right")
for(let i=0;i<t.length;i++)e[i]=e[i]?e[i].concat(t[i]):t[i]}return Ue?e.reverse():e}function Mn(t,e,i){const n=[[]]
for(const s of t){if(!st(s))continue
let t=zn(s)
for(let o=n.length-1;o>=0;o--){const r=n[o]
if(!r[0]){r.push(s)
break}let a
if(r[0].offsetParent===s.offsetParent?a=zn(r[0]):(t=zn(s,!0),a=zn(r[0],!0)),t[e]>=a[i]-1&&t[e]!==a[e]){n.push([s])
break}if(t[i]-1>a[e]||t[e]===a[e]){r.push(s)
break}if(0===o){n.unshift([s])
break}}}return n}function zn(t,e){void 0===e&&(e=!1)
let{offsetTop:i,offsetLeft:n,offsetHeight:s,offsetWidth:o}=t
return e&&([i,n]=fe(t)),{top:i,left:n,bottom:i+s,right:n+o}}var Fn={connected(){Hn(this._uid,(()=>this.$emit("scroll")))},disconnected(){Wn(this._uid)}}
const Ln=new Map
let jn
function Hn(t,e){jn=jn||Ot(window,"scroll",(()=>Ln.forEach((t=>t()))),{passive:!0,capture:!0}),Ln.set(t,e)}function Wn(t){Ln.delete(t),jn&&!Ln.size&&(jn(),jn=null)}var Rn={extends:Dn,mixins:[an],name:"grid",props:{masonry:Boolean,parallax:Number},data:{margin:"uk-grid-margin",clsStack:"uk-grid-stack",masonry:!1,parallax:0},connected(){this.masonry&&Zt(this.$el,"uk-flex-top uk-flex-wrap-top"),this.parallax&&Hn(this._uid,(()=>this.$emit("scroll")))},disconnected(){Wn(this._uid)},update:[{write(t){let{columns:e}=t
ee(this.$el,this.clsStack,e.length<2)},events:["resize"]},{read(t){let{columns:e,rows:i}=t
if(!e.length||!this.masonry&&!this.parallax||qn(this.$el))return t.translates=!1,!1
let n=!1
...
function qn(t){return mt(t).some((t=>"absolute"===Yt(t,"position")))}var Vn={mixins:[bn],args:"target",props:{target:String,row:Boolean},data:{target:"> *",row:!0},computed:{elements:{get(t,e){let{target:i}=t
return Re(i,e)},watch(){this.$reset()}}},resizeTargets(){return[this.$el,...this.elements]},update:{read(){return{rows:(this.row?Bn(this.elements):[this.elements]).map(Un)}},write(t){let{rows:e}=t
for(const{heights:i,elements:n}of e)n.forEach(((t,e)=>Yt(t,"minHeight",i[e])))},events:["resize"]}}
function Un(t){if(t.length<2)return{heights:[""],elements:t}
Yt(t,"minHeight","")
let e=t.map(Gn)
const i=Math.max(...e)
return{heights:t.map(((t,n)=>e[n].toFixed(2)===i.toFixed(2)?"":i)),elements:t}}function Gn(t){let e=!1
st(t)||(e=t.style.display,Yt(t,"display","block","important"))
const i=ce(t).height-ve(t,"height","content-box")
return!1!==e&&Yt(t,"display",e),i}var Yn={mixins:[bn],props:{expand:Boolean,offsetTop:Boolean,offsetBottom:Boolean,minHeight:Number},data:{expand:!1,offsetTop:!1,offsetBottom:!1,minHeight:0},resizeTargets(){return[this.$el,...Di(this.$el,/auto|scroll/)]},update:{read(t){let{minHeight:e}=t
if(!st(this.$el))return!1
let i=""
const n=ve(this.$el,"height","content-box"),{body:s,scrollingElement:o}=document,[r]=Di(this.$el,/auto|scroll/),{height:a}=Bi(r===s?o:r)
...
return es(t,i)?i:Oe(e,t)}const i=e.lastElementChild
return es(t,i)?i:_e(e,t)}(t,this.$el)
return this.svgEl&&e!==this.svgEl&&De(this.svgEl),this.applyAttributes(e,t),this.svgEl=e}}),R),this.strokeAnimation&&this.svg.then((t=>{this._connected&&(Qn(t),this.registerObserver(ai(t,((e,i)=>{Qn(t),i.disconnect()}))))}))},disconnected(){this.svg.then((t=>{this._connected||(nt(this.$el)&&(this.$el.hidden=!1),De(t),this.svgEl=null)})),this.svg=null},methods:{async getSvg(){return Te(this.$el,"img")&&!this.$el.complete&&"lazy"===this.$el.loading?new Promise((t=>Dt(this.$el,"load",(()=>t(this.getSvg()))))):(t=await Zn(this.src),(e=this.icon)&&d(t,"<symbol")&&(t=function(t,e){if(!Kn[t]){let e
for(Kn[t]={},Jn.lastIndex=0;e=Jn.exec(t);)Kn[t][e[3]]='<svg xmlns="http://www.w3.org/2000/svg"'+e[1]+"svg>"}return Kn[t][e]}(t,e)||t),(null==(i=t=We(t.substr(t.indexOf("<svg"))))?void 0:i.hasChildNodes())&&t||Promise.reject("SVG not found."))
...
return 1!==this.ratio&&Yt(We("circle",t),"strokeWidth",1/this.ratio),t}}},ds={},us=Ve&&"loading"in HTMLImageElement.prototype
...
K(e,t),_e(i,e)}_e(i,t)}}(n,i),gs(t,n),n.onload=()=>{ps(t,n.currentSrc)},K(n,"src",e),n}(this.$el,this.dataSrc,this.sources)
return tt(t,"loading"),ps(this.$el,t.currentSrc),this._data.image=t}}}
function ps(t,e){if(vs(t)){const e=ht(t);(!function(t){return Te(t,"picture")}(e)?[t]:mt(e)).forEach((t=>gs(t,t)))}else e&&!d(t.style.backgroundImage,e)&&(Yt(t,"backgroundImage","url("+At(e)+")"),Bt(t,Nt("load",!1)))}const ms=["data-src","data-srcset","sizes"]
function gs(t,e){ms.forEach((i=>{const n=et(t,i)
n&&K(e,i.replace(/^(data-)+/,""),n)}))}function vs(t){return Te(t,"img")}var ws={props:{media:Boolean},data:{media:!1},connected(){const t=function(t,e){if(T(t))if(h(t,"@"))t=P(Yt(e,"--uk-breakpoint-"+t.substr(1)))
else if(isNaN(t))return t
return t&&E(t)?"(min-width: "+t+"px)":""}(this.media,this.$el)
if(this.matchMedia=!0,t){this.mediaObj=window.matchMedia(t)
const e=()=>{this.matchMedia=this.mediaObj.matches,Bt(this.$el,Nt("mediachange",!1,!0,[this.mediaObj]))}
this.offMediaObj=Ot(this.mediaObj,"change",(()=>{e(),this.$emit("resize")})),e()}},disconnected(){var t
null==(t=this.offMediaObj)||t.call(this)}},bs={mixins:[an,ws,bn],props:{fill:String},data:{fill:"",clsWrapper:"uk-leader-fill",clsHide:"uk-leader-hide",attrFill:"data-fill"},computed:{fill(t){let{fill:e}=t
return e||Yt(this.$el,"--uk-leader-fill-content")}},connected(){[this.wrapper]=Ne(this.$el,'<span class="'+this.clsWrapper+'">')},disconnected(){Me(this.wrapper.childNodes)},update:{read(){return{width:Math.trunc(this.$el.offsetWidth/2),fill:this.fill,hide:!this.matchMedia}},write(t){let{width:e,fill:i,hide:n}=t
...
for(const e of Re(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right",this.$el))Yt(e,"flexGrow",t?Re(this.dropdown,e).length:"")},immediate:!0}},disconnected(){this.dropbar&&De(this.dropbar),delete this._dropbar},events:[{name:"mouseover focusin",delegate(){return this.dropdown},handler(t){let{current:e}=t
...
this.isDropbarDrop(e)&&(this.dropbar.previousElementSibling!==this.dropbarAnchor&&Oe(this.dropbarAnchor,this.dropbar),Zt(e,this.clsDrop+"-dropbar"))}},{name:"show",el(){return this.dropContainer},filter(){return this.dropbar},handler(t){let{target:e}=t
...
Yt(e=n<t&&e,"clipPath","polygon(0 0,100% 0,100% "+n+"px,0 "+n+"px)"),pe(i,n),se.cancel([e,i]),Promise.all([se.start(i,{height:t},this.duration),se.start(e,{clipPath:"polygon(0 0,100% 0,100% "+t+"px,0 "+t+"px)"},this.duration)]).catch(R).then((()=>Yt(e,{clipPath:""})))},getDropdown(t){return this.$getComponent(t,"drop")||this.$getComponent(t,"dropdown")},isDropbarDrop(t){return this.getDropdown(t)&&te(t,this.clsDrop)}}}
...
We(":focus",t)||null==(e=We(at,t))||e.focus()}const Ts={TAB:9,ESC:27,LEFT:37,UP:38,RIGHT:39,DOWN:40}
var Is={props:{swiping:Boolean},data:{swiping:!0},computed:{swipeTarget:(t,e)=>e},connected(){this.swiping&&tn(this,{el:this.swipeTarget,name:Xe,passive:!0,handler(t){if(!Rt(t))return
...
Bt(i,"swipe"),Bt(i,"swipe"+(t=e.x,o=e.y,r=n,a=s,Math.abs(t-r)>=Math.abs(o-a)?t-r>0?"Left":"Right":o-a>0?"Up":"Down"))}))}))}})}},Es={mixins:[Tn,Is],args:"mode",props:{mode:String,flip:Boolean,overlay:Boolean},data:{mode:"slide",flip:!1,overlay:!1,clsPage:"uk-offcanvas-page",clsContainer:"uk-offcanvas-container",selPanel:".uk-offcanvas-bar",clsFlip:"uk-offcanvas-flip",clsContainerAnimation:"uk-offcanvas-container-animation",clsSidebarAnimation:"uk-offcanvas-bar-animation",clsMode:"uk-offcanvas",clsOverlay:"uk-offcanvas-overlay",selClose:".uk-offcanvas-close",container:!1},computed:{clsFlip(t){let{flip:e,clsFlip:i}=t
...
!i&&e&&We(e,document.body)&&this.hide()}},{name:"touchmove",self:!0,passive:!1,filter(){return this.overlay},handler(t){t.cancelable&&t.preventDefault()}},{name:"show",self:!0,handler(){"reveal"!==this.mode||te(ht(this.panel),this.clsMode)||(Be(this.panel,"<div>"),Zt(ht(this.panel),this.clsMode))
...
function Cs(){return We('meta[name="viewport"]',document.head)||_e(document.head,'<meta name="viewport">')}var _s={mixins:[an,bn],props:{selContainer:String,selContent:String,minHeight:Number},data:{selContainer:".uk-modal",selContent:".uk-modal-dialog",minHeight:150},computed:{container(t,e){let{selContainer:i}=t
...
Yt(this.$el,{minHeight:this.minHeight,maxHeight:e})},events:["resize"]}},As={mixins:[bn],props:["width","height"],resizeTargets(){return[this.$el,ht(this.$el)]},connected(){Zt(this.$el,"uk-responsive-width")},update:{read(){return!!(st(this.$el)&&this.width&&this.height)&&{width:me(ht(this.$el)),height:this.height}},write(t){pe(this.$el,Y.contain({height:this.height,width:this.width},t).height)},events:["resize"]}},Os={props:{offset:Number},data:{offset:0},connected(){Ps.size||Ot(document,"click",Ds),Ps.add(this)},disconnected(){Ps.delete(this),Ps.size||Pt(document,"click",Ds)},methods:{async scrollTo(t){t=t&&We(t)||document.body,Bt(this.$el,"beforescroll",[this,t])&&(await Oi(t,{offset:this.offset}),Bt(this.$el,"scrolled",[this,t]))}}}
const Ps=new Set
function Ds(t){if(!t.defaultPrevented)for(const e of Ps)ft(t.target,e.$el)&&(t.preventDefault(),e.scrollTo(Bs(e.$el)))}function Bs(t){return document.getElementById(decodeURIComponent(t.hash).substring(1))}var Ns={mixins:[Fn],args:"cls",props:{cls:String,target:String,hidden:Boolean,offsetTop:Number,offsetLeft:Number,repeat:Boolean,delay:Number},data:()=>({cls:"",target:!1,hidden:!0,offsetTop:0,offsetLeft:0,repeat:!1,delay:0,inViewClass:"uk-scrollspy-inview"}),computed:{elements:{get(t,e){let{target:i}=t
return i?Re(i,e):[e]},watch(t,e){this.hidden&&Yt(ct(t,":not(."+this.inViewClass+")"),"visibility","hidden"),M(t,e)||this.$reset()},immediate:!0}},connected(){this._data.elements=new Map,this.registerObserver(ai(this.elements,(t=>{const e=this._data.elements
...
e?i.off=Dt(t,"animationcancel animationend",n):n()}Bt(t,e?"inview":"outview"),i.inview=e,this.$update(t)}}}},Ms={mixins:[Fn],props:{cls:String,closest:String,scroll:Boolean,overflow:Boolean,offset:Number},data:{cls:"uk-active",closest:!1,scroll:!1,overflow:!0,offset:0},computed:{links:{get:(t,e)=>Re('a[href^="#"]',e).filter((t=>t.hash)),watch(t){this.scroll&&this.$create("scroll",t,{offset:this.offset||0})},immediate:!0},elements(t){let{closest:e}=t
return ut(this.links,e||"*")}},update:[{read(){const t=this.links.map(Bs).filter(Boolean),{length:e}=t
if(!e||!st(this.$el))return!1
const[i]=Di(t,/auto|scroll/,!0),{scrollTop:n,scrollHeight:s}=i,o=Bi(i)
let r=!1
...
Yt(n,{height:e,margin:i}),ft(n,document)||(Oe(this.$el,n),n.hidden=!0)},events:["resize"]},{read(t){let{scroll:e=0,dir:i="down",overflow:n,overflowScroll:s=0,start:o,end:r}=t
const a=document.scrollingElement.scrollTop
return{dir:e<=a?"down":"up",prevDir:i,scroll:a,prevScroll:e,offsetParentTop:de((this.isFixed?this.placeholder:this.$el).offsetParent).top,overflowScroll:W(s+W(a,o,r)-W(e,o,r),0,n)}},write(t,e){const i=e.has("scroll"),{initTimestamp:n=0,dir:s,prevDir:o,scroll:r,prevScroll:a=0,top:l,start:h,topOffset:c,height:d}=t
...
this.active=t,t?(Qt(this.selTarget,this.clsInactive,this.clsActive),e!==t&&Bt(this.$el,"active")):(Qt(this.selTarget,this.clsActive,this.clsInactive),e!==t&&Bt(this.$el,"inactive"))}}}
function Fs(t,e,i,n){if(!t)return 0
if(E(t)||T(t)&&t.match(/^-?\d/))return i+be(t,"height",e,!0)
{const i=!0===t?ht(e):vt(t,e)
return de(i).bottom-(n&&i&&ft(e,i)?P(Yt(i,"paddingBottom")):0)}}function Ls(t){return"true"===t||"false"!==t&&t}var js={mixins:[ln,Is,hn],args:"connect",props:{connect:String,toggle:String,itemNav:String,active:Number},data:{connect:"~.uk-switcher",toggle:"> * > :first-child",itemNav:!1,active:0,cls:"uk-active",attrItem:"uk-switcher-item"},computed:{connects:{get(t,e){let{connect:i}=t
return wt(i,e)},watch(t){this.swiping&&Yt(t,"touchAction","pan-y pinch-zoom")
const e=this.index()
this.connects.forEach((t=>{mt(t).forEach(((t,i)=>ee(t,this.cls,i===e))),this.lazyload(this.$el,mt(t))}))},immediate:!0},toggles:{get(t,e){let{toggle:i}=t
...
await this.toggleElement(B(e).filter((t=>te(t,this.cls))),!1,s),await this.toggleElement(e[n],!0,s)}))}}},Hs={mixins:[an],extends:js,props:{media:Boolean},data:{media:960,attrItem:"uk-tab-item"},connected(){const t=te(this.$el,"uk-tab-left")?"uk-tab-left":!!te(this.$el,"uk-tab-right")&&"uk-tab-right"
t&&this.$create("toggle",this.$el,{cls:t,mode:"media",media:this.media})}},Ws={mixins:[ln,ws,hn],args:"target",props:{href:String,target:null,mode:"list",queued:Boolean},data:{href:!1,target:!1,mode:"click",queued:!0},computed:{target:{get(t,e){let{href:i,target:n}=t
return n=wt(n||i,e),n.length&&n||[e]},watch(){this.updateAria(),this.lazyload(this.$el,this.target)},immediate:!0}},connected(){d(this.mode,"media")||lt(this.$el)||K(this.$el,"tabindex","0"),Se((()=>this.$emit()))},events:[{name:Xe,filter(){return d(this.mode,"hover")},handler(t){this._preventClick=null,Rt(t)&&!this._showState&&(Bt(this.$el,"focus"),Dt(document,Xe,(()=>Bt(this.$el,"blur")),!0,(t=>!ft(t.target,this.$el))),d(this.mode,"click")&&(this._preventClick=!0))}},{name:Ke+" "+Qe+" focus blur",filter(){return d(this.mode,"hover")},handler(t){if(Rt(t))return
...
this.updateAria("show"===e)}},{name:"mediachange",filter(){return d(this.mode,"media")},el(){return this.target},handler(t,e){e.matches^this.isToggled(this.target)&&this.toggle()}}],methods:{async toggle(t){if(!Bt(this.target,t||"toggle",[this]))return
...
L(Object.freeze({__proto__:null,Accordion:fn,Alert:gn,Cover:yn,Drop:On,Dropdown:On,FormCustom:Pn,Grid:Rn,HeightMatch:Vn,HeightViewport:Yn,Icon:ss,Img:fs,Leader:bs,Margin:Dn,Modal:ys,Nav:xs,Navbar:ks,Offcanvas:Es,OverflowAuto:_s,Responsive:As,Scroll:Os,Scrollspy:Ns,ScrollspyNav:Ms,Sticky:zs,Svg:Xn,Switcher:js,Tab:Hs,Toggle:Ws,Video:wn,Close:hs,Spinner:cs,NavParentIcon:rs,SlidenavNext:as,SlidenavPrevious:as,SearchIcon:ls,Marker:os,NavbarParentIcon:os,NavbarToggleIcon:os,OverlayIcon:os,PaginationNext:os,PaginationPrevious:os,Totop:os}),((t,e)=>rn.component(e,t))),function(t){const{connect:e,disconnect:i}=t
...
for(const e of Rs){const i=We(this.clsWrapper.replace("%unit%",e),this.$el)
if(!i)continue
...
return te(e,Vs)?Xs(e).then(h):te(e,Us)?Xs(e).then(l).then(h):l().then(h)}function Ys(t,e){return e&&(t.dataset.transition=1+Ys(t)),O(t.dataset.transition)||0}function Xs(t){return Promise.all(mt(t).filter(se.inProgress).map((t=>new Promise((e=>Dt(t,"transitionend transitioncanceled",e))))))}function Zs(t){return Bn(mt(t)).reduce(((t,e)=>t.concat(j(e.filter((t=>Ai(t))),"offsetLeft"))),[])}async function Js(t,e,i){await eo()
let n=mt(e)
const s=n.map((t=>Ks(t,!0))),o=Yt(e,["height","padding"])
se.cancel(e),n.forEach(se.cancel),Qs(e),t(),n=n.concat(mt(e).filter((t=>!d(n,t)))),await Promise.resolve(),ei.flush()
const r=Yt(e,["height","padding"]),[a,l]=function(t,e,i){const n=e.map(((t,e)=>!(!ht(t)||!(e in i))&&(i[e]?st(t)?to(t):{opacity:0}:{opacity:st(t)?1:0}))),s=n.map(((n,s)=>{const o=ht(e[s])===t&&(i[s]||Ks(e[s]))
if(!o)return!1
if(n){if(!("opacity"in n)){const{opacity:t}=o
t%1?n.opacity=1:delete o.opacity}}else delete o.opacity
return o}))
return[n,s]}(e,n,s)
n.forEach(((t,e)=>l[e]&&Yt(t,l[e]))),Yt(e,{display:"block",...o}),await eo()
const h=n.map(((t,n)=>ht(t)===e&&se.start(t,a[n],i,"ease"))).concat(se.start(e,r,i,"ease"))
await Promise.all(h).then((()=>{n.forEach(((t,i)=>ht(t)===e&&Yt(t,"display",0===a[i].opacity?"none":""))),Qs(e)}),R)}function Ks(t,e){const i=Yt(t,"zIndex")
return!!st(t)&&{display:"",opacity:e?Yt(t,"opacity"):"0",pointerEvents:"none",position:"absolute",zIndex:"auto"===i?gt(t):i,...to(t)}}function Qs(t){Yt(t.children,{height:"",left:"",opacity:"",pointerEvents:"",position:"",top:"",marginTop:"",marginLeft:"",transform:"",width:"",zIndex:""}),Yt(t,{height:"",display:"",padding:""})}function to(t){const{height:e,width:i}=de(t),{top:n,left:s}=ue(t),{marginLeft:o,marginTop:r}=Yt(t,["marginTop","marginLeft"])
return{top:n,left:s,height:e,width:i,marginLeft:o,marginTop:r,transform:""}}function eo(){return new Promise((t=>requestAnimationFrame(t)))}var io={props:{duration:Number,animation:Boolean},data:{duration:150,animation:"slide"},methods:{animate(t,e){void 0===e&&(e=this.$el)
...
return n(t,e,this.duration).then((()=>this.$update(e,"resize")),R)}}},no={mixins:[io],args:"target",props:{target:Boolean,selActive:Boolean},data:{target:null,selActive:!1,attrItem:"uk-filter-control",cls:"uk-active",duration:250},computed:{toggles:{get(t,e){let{attrItem:i}=t
...
e&&(n=e,(i=t).length!==n.length||!i.every((t=>n.includes(t))))&&this.updateState()},immediate:!0}},events:[{name:"click",delegate(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler(t){t.preventDefault(),this.apply(t.current)}}],methods:{apply(t){const e=this.getState(),i=oo(t,this.attrItem,this.getState())
var n,s
n=e,s=i,["filter","sort"].every((t=>M(n[t],s[t])))||this.setState(i)},getState(){return this.toggles.filter((t=>te(t,this.cls))).reduce(((t,e)=>oo(e,this.attrItem,t)),{filter:{"":""},sort:[]})},async setState(t,e){void 0===e&&(e=!0),t={filter:{"":""},sort:[],...t},Bt(this.$el,"beforeFilter",[this,t]),this.toggles.forEach((e=>ee(e,this.cls,!!function(t,e,i){let{filter:n={"":""},sort:[s,o]}=i
const{filter:r="",group:a="",sort:l,order:h="asc"}=so(t,e)
...
return e?this.animate(n,i):n()}))),Bt(this.$el,"afterFilter",[this])},updateState(){ei.write((()=>this.setState(this.getState(),!1)))}}}
function so(t,e){return wi(et(t,e),["filter"])}function oo(t,e,i){const n=so(t,e),{filter:s,group:o,sort:r,order:a="asc"}=n
return(s||_(r))&&(o?s?(delete i.filter[""],i.filter[o]=s):(delete i.filter[o],(C(i.filter)||""in i.filter)&&(i.filter={"":s||""})):i.filter={"":s||""}),_(r)||(i.sort=[r,a]),i}var ro={slide:{show:t=>[{transform:lo(-100*t)},{transform:lo()}],percent:t=>ao(t),translate:(t,e)=>[{transform:lo(-100*e*t)},{transform:lo(100*e*(1-t))}]}}
function ao(t){return Math.abs(Yt(t,"transform").split(",")[4]/t.offsetWidth)||0}function lo(t,e){return void 0===t&&(t=0),void 0===e&&(e="%"),"translate3d("+(t+=t?e:"")+", 0, 0)"}function ho(t){return"scale3d("+t+", "+t+", 1)"}var co={...ro,fade:{show:()=>[{opacity:0},{opacity:1}],percent:t=>1-Yt(t,"opacity"),translate:t=>[{opacity:1-t},{opacity:t}]},scale:{show:()=>[{opacity:0,transform:ho(.8)},{opacity:1,transform:ho(1)}],percent:t=>1-Yt(t,"opacity"),translate:t=>[{opacity:1-t,transform:ho(1-.2*t)},{opacity:t,transform:ho(.8+.2*t)}]}}
function uo(t,e,i){Bt(t,Nt(e,!1,!1,i))}var fo={props:{autoplay:Boolean,autoplayInterval:Number,pauseOnHover:Boolean},data:{autoplay:!1,autoplayInterval:7e3,pauseOnHover:!0},connected(){this.autoplay&&this.startAutoplay()},disconnected(){this.stopAutoplay()},update(){K(this.slides,"tabindex","-1")},events:[{name:"visibilitychange",el:()=>document,filter(){return this.autoplay},handler(){document.hidden?this.stopAutoplay():this.startAutoplay()}}],methods:{startAutoplay(){this.stopAutoplay(),this.interval=setInterval((()=>(!this.draggable||!We(":focus",this.$el))&&(!this.pauseOnHover||!dt(this.$el,":hover"))&&!this.stack.length&&this.show("next")),this.autoplayInterval)},stopAutoplay(){this.interval&&clearInterval(this.interval)}}}
const po={passive:!1,capture:!0},mo="touchmove mousemove",go="touchend touchcancel mouseup click input"
...
!this.draggable||!Rt(t)&&!(e=t.target).children.length&&e.childNodes.length||ut(t.target,ot)||t.button>0||this.length<2||this.start(t)}},{name:"dragstart",handler(t){t.preventDefault()}},{name:mo+" "+go,el(){return this.list},handler:R,...po}],methods:{start(){this.drag=this.pos,this._transitioner?(this.percent=this._transitioner.percent(),this.drag+=this._transitioner.getDistance()*this.percent*this.dir,this._transitioner.cancel(),this._transitioner.translate(this.percent),this.dragging=!0,this.stack=[]):this.prevIndex=this.index,Ot(document,mo,this.move,po),Ot(document,go,this.end,po),Yt(this.list,"userSelect","none")},move(t){const e=this.pos-this.drag
...
let u;[this.index,this.prevIndex].filter((t=>!d([o,n],t))).forEach((t=>{Bt(i[t],"itemhidden",[this]),c&&(u=!0,this.prevIndex=n)})),(this.index===n&&this.prevIndex!==n||u)&&Bt(i[this.index],"itemshown",[this]),h&&(this.prevIndex=n,this.index=o,!c&&Bt(a,"beforeitemhide",[this]),Bt(l,"beforeitemshow",[this])),this._transitioner=this._translate(Math.abs(this.percent),a,!c&&l),h&&(!c&&Bt(a,"itemhide",[this]),Bt(l,"itemshow",[this]))},end(){if(Pt(document,mo,this.move,po),Pt(document,go,this.end,po),this.dragging)if(this.dragging=null,this.index===this.prevIndex)this.percent=1-this.percent,this.dir*=-1,this._show(!1,this.index,!0),this._transitioner=null
else{const t=(Ue?this.dir*(Ue?1:-1):this.dir)<0==this.prevPos>this.pos
this.index=t?this.index:this.prevIndex,t&&(this.percent=1-this.percent),this.show(this.dir>0&&!t||this.dir<0&&t?"next":"previous",!0)}Yt(this.list,{userSelect:"",pointerEvents:""}),this.drag=this.percent=null}}},wo={mixins:[fo,vo,{data:{selNav:!1},computed:{nav(t,e){let{selNav:i}=t
return We(i,e)},selNavItem(t){let{attrItem:e}=t
return"["+e+"],[data-"+e+"]"},navItems(t,e){return Re(this.selNavItem,e)}},update:{write(){this.nav&&this.length!==this.nav.children.length&&Ee(this.nav,this.slides.map(((t,e)=>"<li "+this.attrItem+'="'+e+'"><a href></a></li>')).join("")),this.navItems.concat(this.nav).forEach((t=>t&&(t.hidden=!this.maxIndex))),this.updateNav()},events:["resize"]},events:[{name:"click",delegate(){return this.selNavItem},handler(t){t.preventDefault(),this.show(et(t.current,this.attrItem))}},{name:"itemshow",handler:"updateNav"}],methods:{updateNav(){const t=this.getValidIndex()
...
return We(i,e)},maxIndex(){return this.length-1},selSlides(t){let{selList:e,selSlides:i}=t
...
function bo(t){return.5*t+300}var yo={mixins:[wo],props:{animation:String},data:{animation:"slide",clsActivated:"uk-transition-active",Animations:ro,Transitioner:function(t,e,i,n){let{animation:s,easing:o}=n
const{percent:r,translate:a,show:l=R}=s,h=l(i),c=new J
return{dir:i,show(n,s,r){void 0===s&&(s=0)
const a=r?"linear":o
return n-=Math.round(n*W(s,-1,1)),this.translate(s),uo(e,"itemin",{percent:s,duration:n,timing:a,dir:i}),uo(t,"itemout",{percent:1-s,duration:n,timing:a,dir:i}),Promise.all([se.start(e,h[1],n,a),se.start(t,h[0],n,a)]).then((()=>{this.reset(),c.resolve()}),R),c.promise},cancel(){se.cancel([e,t])},reset(){for(const i in h[0])Yt([e,t],i,"")},forward(i,n){return void 0===n&&(n=this.percent()),se.cancel([e,t]),this.show(i,n,!0)},translate(n){this.reset()
const s=a(n,i)
Yt(e,s[1]),Yt(t,s[0]),uo(e,"itemtranslatein",{percent:n,dir:i}),uo(t,"itemtranslateout",{percent:1-n,dir:i})},percent:()=>r(t||e,e,i),getDistance:()=>null==t?void 0:t.offsetWidth}}},computed:{animation(t){let{animation:e,Animations:i}=t
...
Ot(t,"loadedmetadata",(()=>{K(t,{width:t.videoWidth,height:t.videoHeight}),this.setItem(e,t)})),Ot(t,"error",(()=>this.setError(e)))}else if("iframe"===n||i.match(/\.(html|php)($|\?)/i))this.setItem(e,ko("iframe",{src:i,frameborder:"0",allowfullscreen:"",class:"uk-lightbox-iframe",...r}))
...
return i===e}))}return this.panel=this.panel||this.$create("lightboxPanel",{...this.$props,items:e}),Ot(this.panel.$el,"hidden",(()=>this.panel=!1)),this.panel.show(t)},hide(){var t
...
Bt(t,"close",[this]),De(t),null!=e&&e.hasChildNodes()||De(e)})(this.$el)}}}
const Io={x:_o,y:_o,rotate:_o,scale:_o,color:Ao,backgroundColor:Ao,borderColor:Ao,blur:Oo,hue:Oo,fopacity:Oo,grayscale:Oo,invert:Oo,saturate:Oo,sepia:Oo,opacity:function(t,e,i){return 1===i.length&&i.unshift(Wo(e,t,"")),i=zo(i),(e,n)=>{e[t]=Lo(i,n)}},stroke:function(t,e,i){1===i.length&&i.unshift(0)
const n=Ho(i),s=ts(e)
return i=zo(i.reverse(),(t=>(t=P(t),"%"===n?t*s/100:t))),i.some((t=>{let[e]=t
return e}))?(Yt(e,"strokeDasharray",s),(t,e)=>{t.strokeDashoffset=Lo(i,e)}):R},bgx:Po,bgy:Po},{keys:Eo}=Object
var Co={mixins:[ws],props:Ro(Eo(Io),"list"),data:Ro(Eo(Io),void 0),computed:{props(t,e){const i={}
...
return"x"===t||"y"===t?(t="translate"+a(t),n=t=>P(P(t).toFixed("px"===s?0:6))):"scale"===t&&(s="",n=t=>Ho([t])?be(t,"width",e,!0)/e.offsetWidth:t),1===i.length&&i.unshift("scale"===t?1:0),i=zo(i,n),(e,n)=>{e.transform+=" "+t+"("+Lo(i,n)+s+")"}}function Ao(t,e,i){return 1===i.length&&i.unshift(Wo(e,t,"")),i=zo(i,(t=>function(t,e){return Wo(t,"color",e).split(/[(),]/g).slice(1,-1).concat(1).slice(0,4).map(P)}(e,t))),(e,n)=>{const[s,o,r]=Fo(i,n),a=s.map(((t,e)=>(t+=r*(o[e]-t),3===e?P(t):parseInt(t,10)))).join(",")
e[t]="rgba("+a+")"}}function Oo(t,e,i){1===i.length&&i.unshift(0)
const n=Ho(i)||{blur:"px",hue:"deg"}[t]||"%"
return t={fopacity:"opacity",hue:"hue-rotate"}[t]||t,i=zo(i),(e,s)=>{const o=Lo(i,s)
...
if(No[e])return No[e]
const i=new Image
return e&&(i.src=e,!i.naturalWidth)?(i.onload=()=>{No[e]=Mo(i),Bt(t,Nt("load",!1))},Mo(i)):No[e]=Mo(i)}(e)
if(!s.width)return R
...
a[c]="max("+Do(e,c)+",-"+i+"px) + "+a[c]}const h=Bo(r,a,n)
return(t,e)=>{h(t,e),t.backgroundSize=l.width+"px "+l.height+"px",t.backgroundRepeat="no-repeat"}}(0,e,0,n)
const r={}
for(const a of o)r[a]=Do(e,a)
return Bo(o,r,n)}function Do(t,e){return Wo(t,"background-position-"+e.substr(-1),"")}function Bo(t,e,i){return function(n,s){for(const o of t){const t=Lo(i[o],s)
n["background-position-"+o.substr(-1)]="calc("+e[o]+" + "+t+"px)"}}}const No={}
...
return e<=i}))+1
return[t[i-1][0],t[i][0],(e-t[i-1][1])/(t[i][1]-t[i-1][1])]}function Lo(t,e){const[i,n,s]=Fo(t,e)
return I(i)?i+Math.abs(i-n)*s*(i<n?1:-1):+n}const jo=/^-?\d+(\S+)/
function Ho(t,e){for(const i of t){const t=null==i.match?void 0:i.match(jo)
if(t)return t[1]}return e}function Wo(t,e,i){const n=t.style[e],s=Yt(Yt(t,e,i),e)
return t.style[e]=n,s}function Ro(t,e){return t.reduce(((t,i)=>(t[i]=e,t)),{})}var qo={mixins:[Co,bn,Fn],props:{target:String,viewport:Number,easing:Number,start:String,end:String},data:{target:!1,viewport:1,easing:1,start:0,end:0},computed:{target(t,e){let{target:i}=t
...
~this.prevIndex&&this.index===t?this._translate(1,this.prevIndex,this.index):this.show(t)},events:["resize"]}},Go={mixins:[ln],connected(){this.lazyload(this.slides,this.getAdjacentSlides)}}
function Yo(t,e,i){const n=Jo(t,e)
return i?n-function(t,e){return ce(e).width/2-ce(t).width/2}(t,e):Math.min(n,Xo(e))}function Xo(t){return Math.max(0,Zo(t)-ce(t).width)}function Zo(t){return mt(t).reduce(((t,e)=>ce(e).width+t),0)}function Jo(t,e){return t&&(ue(t).left+(Ue?ce(t).width-ce(e).width:0))*(Ue?-1:1)||0}function Ko(t,e){e-=1
const i=ce(t).width,n=e+i+2
return mt(t).filter((s=>{const o=Jo(s,t),r=o+Math.min(ce(s).width,i)
return o>=e&&r<=n}))}function Qo(t,e,i){Bt(t,Nt(e,!1,!1,i))}var tr={mixins:[an,wo,Uo,Go],props:{center:Boolean,sets:Boolean},data:{center:!1,sets:!1,attrItem:"uk-slider-item",selList:".uk-slider-items",selNav:".uk-slider-nav",clsContainer:"uk-slider-container",Transitioner:function(t,e,i,n){let{center:s,easing:o,list:r}=n
const a=new J,l=t?Yo(t,r,s):Yo(e,r,s)+ce(e).width*i,h=e?Yo(e,r,s):l+ce(t).width*i*(Ue?-1:1)
return{dir:i,show(e,n,s){void 0===n&&(n=0)
const l=s?"linear":o
return e-=Math.round(e*W(n,-1,1)),this.translate(n),n=t?n:W(n,0,1),Qo(this.getItemIn(),"itemin",{percent:n,duration:e,timing:l,dir:i}),t&&Qo(this.getItemIn(!0),"itemout",{percent:1-n,duration:e,timing:l,dir:i}),se.start(r,{transform:lo(-h*(Ue?-1:1),"px")},e,l).then(a.resolve,R),a.promise},cancel(){se.cancel(r)},reset(){Yt(r,"transform","")},forward(t,e){return void 0===e&&(e=this.percent()),se.cancel(r),this.show(t,e,!0)},translate(n){const s=this.getDistance()*i*(Ue?-1:1)
Yt(r,"transform",lo(W(s-s*n-h,-Zo(r),ce(r).width)*(Ue?-1:1),"px"))
const o=this.getActives(),a=this.getItemIn(),l=this.getItemIn(!0)
n=t?W(n,-1,1):0
for(const h of mt(r)){const s=d(o,h),c=h===a,u=h===l
Qo(h,"itemtranslate"+(c||!u&&(s||i*(Ue?-1:1)==-1^Jo(h,r)>Jo(t||e))?"in":"out"),{dir:i,percent:u?1-n:c?n:s?1:0})}},percent:()=>Math.abs((Yt(r,"transform").split(",")[4]*(Ue?-1:1)+l)/(h-l)),getDistance:()=>Math.abs(h-l),getItemIn(i){void 0===i&&(i=!1)
...
ei.read((()=>{const t=this.getCss(nr(e,o,i)),r=this.getCss(ir(e)?.5:o>0?1:0)
ei.write((()=>{Yt(this.$el,t),se.start(this.$el,r,n,s).catch(R)}))}))}},{name:"transitioncanceled transitionend",self:!0,el(){return this.item},handler(){se.cancel(this.$el)}},{name:"itemtranslatein itemtranslateout",self:!0,el(){return this.item},handler(t){let{type:e,detail:{percent:i,dir:n}}=t
ei.read((()=>{const t=this.getCss(nr(e,n,i))
ei.write((()=>Yt(this.$el,t)))}))}}]}
function ir(t){return c(t,"in")}function nr(t,e,i){return i/=2,ir(t)^e<0?i:1-i}var sr={...ro,fade:{show:()=>[{opacity:0,zIndex:0},{zIndex:-1}],percent:t=>1-Yt(t,"opacity"),translate:t=>[{opacity:1-t,zIndex:0},{zIndex:-1}]},scale:{show:()=>[{opacity:0,transform:ho(1.5),zIndex:0},{zIndex:-1}],percent:t=>1-Yt(t,"opacity"),translate:t=>[{opacity:1-t,transform:ho(1+.5*t),zIndex:0},{zIndex:-1}]},pull:{show:t=>t<0?[{transform:lo(30),zIndex:-1},{transform:lo(),zIndex:0}]:[{transform:lo(-100),zIndex:0},{transform:lo(),zIndex:-1}],percent:(t,e,i)=>i<0?1-ao(e):ao(t),translate:(t,e)=>e<0?[{transform:lo(30*t),zIndex:-1},{transform:lo(-100*(1-t)),zIndex:0}]:[{transform:lo(100*-t),zIndex:0},{transform:lo(30*(1-t)),zIndex:-1}]},push:{show:t=>t<0?[{transform:lo(100),zIndex:0},{transform:lo(),zIndex:-1}]:[{transform:lo(-30),zIndex:-1},{transform:lo(),zIndex:0}],percent:(t,e,i)=>i>0?1-ao(e):ao(t),translate:(t,e)=>e<0?[{transform:lo(100*t),zIndex:0},{transform:lo(-30*(1-t)),zIndex:-1}]:[{transform:lo(-30*t),zIndex:-1},{transform:lo(100*(1-t)),zIndex:0}]}},or={mixins:[an,yo,Uo,Go],props:{ratio:String,minHeight:Number,maxHeight:Number},data:{ratio:"16:9",minHeight:!1,maxHeight:!1,selList:".uk-slideshow-items",attrItem:"uk-slideshow-item",selNav:".uk-slideshow-nav",Animations:sr},update:{read(){if(!this.list)return!1
...
return i?Re(i,e):this.items},watch(t,e){Yt(e,{touchAction:"",userSelect:""}),Yt(t,{touchAction:Ge?"none":"",userSelect:"none"})},immediate:!0}},update:{write(t){if(!this.drag||!ht(this.placeholder))return
...
!s||n||i>0||rt(e)||ft(e,"."+this.clsNoDrag)||this.handle&&!ft(e,this.handle)||(t.preventDefault(),this.touched=new Set([this]),this.placeholder=s,this.origin={target:e,index:gt(s),...this.pos},Ot(document,Ze,this.move),Ot(document,Je,this.end),this.threshold||this.start(t))},start(t){this.drag=function(t,e){const i=_e(t,e.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g,"$1div$2"))
...
m(this.origin,{offsetLeft:this.pos.x-e,offsetTop:this.pos.y-i}),Zt(this.drag,this.clsDrag,this.clsCustom),Zt(this.placeholder,this.clsPlaceholder),Zt(this.items,this.clsItem),Zt(document.documentElement,this.clsDragState),Bt(this.$el,"start",[this,this.placeholder]),function(t){let e=Date.now()
...
this===t?this.origin.index!==gt(this.placeholder)&&Bt(this.$el,"moved",[this,this.placeholder]):(Bt(t.$el,"added",[t,this.placeholder]),Bt(this.$el,"removed",[this,this.placeholder])),Bt(this.$el,"stop",[this,this.placeholder]),De(this.drag),this.drag=null
for(const{clsPlaceholder:e,clsItem:i}of this.touched)for(const t of this.touched)Jt(t.items,e,i)
this.touched=null,Jt(document.documentElement,this.clsDragState)},insert(t,e){Zt(this.items,this.clsItem),this.animate((()=>e?Ae(e,t):_e(this.target,t)))},remove(t){ft(t,this.target)&&this.animate((()=>De(t)))},getSortable(t){do{const e=this.$getComponent(t,"sortable")
if(e&&(e===this||!1!==this.group&&e.group===this.group))return e}while(t=ht(t))}}}
let ar
function lr(t,e){return t[1]>e[0]&&e[1]>t[0]}var hr={mixins:[kn,hn,$n],args:"title",props:{delay:Number,title:String},data:{pos:"top",title:"",delay:0,animation:["uk-animation-scale-up"],duration:100,cls:"uk-active"},beforeConnect(){var t
