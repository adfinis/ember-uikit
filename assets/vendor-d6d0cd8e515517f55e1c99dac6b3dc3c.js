...
e.default=ve})),t("@ember/-internals/bootstrap")}(),"undefined"==typeof FastBoot&&/*! UIkit 3.16.15 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */
...
for(let[o,l,u,c]of[["width","x","left","right"],["height","y","top","bottom"]]){b(i)?i=n:s[u]+=M(We(i,`border-${u}-width`))
const e=s[o]%1
s[o]=s[l]=i[`client${a(o)}`]-(e?e<.5?-e:1-e:0),s[c]=s[o]+s[u]}return s}function Mr(e){return I(e).document.scrollingElement}const Rr=[["width","x","left","right"],["height","y","top","bottom"]]
...
_n.util=Gr,_n.options={},_n.version="3.16.15"
...
We(this.$el,{[o]:(n[a]>u[a]?n[this.inset?l:a]-Math.max(St(this.boundary[i])[a],e[i][a]+t):Math.min(St(this.boundary[i])[l],e[i][l]-t)-n[this.inset?a:l])-r,[`overflow-${s}`]:"auto"}),this.positionAt(this.$el,this.target,this.boundary)}}}}
...
t&&De(this.$el,"active",[e,this.elements[e]])},events:["scroll","resize"]}]},ws={mixins:[Fn,es],props:{position:String,top:null,bottom:null,start:null,end:null,offset:String,overflowFlip:Boolean,animation:String,clsActive:String,clsInactive:String,clsFixed:String,clsBelow:String,selTarget:String,showOnUp:Boolean,targetOffset:Number},data:{position:"top",top:!1,bottom:!1,start:!1,end:!1,offset:0,overflowFlip:!1,animation:"",clsActive:"uk-active",clsInactive:"",clsFixed:"uk-sticky-fixed",clsBelow:"uk-sticky-below",selTarget:"",showOnUp:!1,targetOffset:!1},computed:{selTarget:({selTarget:e},t)=>e&&Ot(e,t)||t},connected(){this.start=ks(this.start||this.top),this.end=ks(this.end||this.bottom),this.placeholder=Ot("+ .uk-sticky-placeholder",this.$el)||Ot('<div class="uk-sticky-placeholder"></div>'),this.isFixed=!1,this.setActive(!1)},disconnected(){this.isFixed&&(this.hide(),Ke(this.selTarget,this.clsInactive)),xs(this.$el),mt(this.placeholder),this.placeholder=null},observe:[Vn({target:({$el:e})=>[e,document.documentElement]}),Gn()],events:[{name:"resize",el:()=>[window,window.visualViewport],handler(){this.$emit("resize")}},{name:"load hashchange popstate",el:()=>window,filter(){return!1!==this.targetOffset},handler(){const{scrollingElement:e}=document
location.hash&&0!==e.scrollTop&&setTimeout((()=>{const t=St(Ot(location.hash)),r=St(this.$el)
this.isFixed&&q(t,r)&&(e.scrollTop=t.top-r.height-Dt(this.targetOffset,"height",this.placeholder)-Dt(this.offset,"height",this.placeholder))}))}},{name:"transitionstart",capture:!0,handler(){this.transitionInProgress=Le(this.$el,"transitionend transitioncancel",(()=>this.transitionInProgress=null))}}],update:[{read({height:e,width:t,margin:r,sticky:n}){if(this.inactive=!this.matchMedia||!se(this.$el),this.inactive)return
const i=this.isFixed&&!this.transitionInProgress
i&&(Os(this.selTarget),this.hide()),this.active||(({height:e,width:t}=St(this.$el)),r=We(this.$el,"margin")),i&&this.show()
const s=Dt("100vh","height"),o=Rt(window),a=document.scrollingElement.scrollHeight-s
let l=this.position
this.overflowFlip&&e>s&&(l="top"===l?"bottom":"top")
const u=this.isFixed?this.placeholder:this.$el
let c=Dt(this.offset,"height",n?this.$el:u)
"bottom"===l&&(e<o||this.overflowFlip)&&(c+=o-e)
const d=this.overflowFlip?0:Math.max(0,e+c-s),h=St(u).top,p=St(this.$el).height,f=(!1===this.start?h:_s(this.start,this.$el,h))-c,m=!1===this.end?a:Math.min(a,_s(this.end,this.$el,h+e,!0)-p-c+d)
return n=a&&!this.showOnUp&&f+c===h&&m===Math.min(a,_s("!*",this.$el,0,!0)-p-c+d)&&"visible"===We(ce(this.$el),"overflowY"),{start:f,end:m,offset:c,overflow:d,topOffset:h,height:e,elHeight:p,width:t,margin:r,top:Mt(u)[0],sticky:n}},write({height:e,width:t,margin:r,offset:n,sticky:i}){if((this.inactive||i||!this.isFixed)&&xs(this.$el),this.inactive)return
i&&(e=t=r=0,We(this.$el,{position:"sticky",top:n}))
const{placeholder:s}=this
We(s,{height:e,width:t,margin:r}),fe(s,document)||(s.hidden=!0),(i?ht:pt)(this.$el,s)},events:["resize"]},{read({scroll:e=0,dir:t="down",overflow:r,overflowScroll:n=0,start:i,end:s}){const o=document.scrollingElement.scrollTop
...
let r
for(Ss.lastIndex=0;r=Ss.exec(e);)t[r[3]]=`<svg ${r[1]}svg>`
return t}))
...
return t.willChange=Object.keys(t).filter((e=>""!==t[e])).map(Ye).join(","),t}}}
...
for(const n of this.slides){const i=c(e,n)
Je(n,t,i),J(n,"aria-hidden",!i)
for(const e of Et(le,n))r(e,"_tabindex")||(e._tabindex=J(e,"tabindex")),J(e,"tabindex",i?e._tabindex:-1)}},getValidIndex(e=this.index,t=this.prevIndex){if(e=this.getIndex(e,t),!this.sets)return e
let r
