...
t&&(n=t,(r=e).length!==n.length||!r.every((e=>~n.indexOf(e))))&&this.updateState()},immediate:!0}},events:[{name:"click",delegate(){return"["+this.attrItem+"],[data-"+this.attrItem+"]"},handler(e){e.preventDefault(),this.apply(e.current)}}],methods:{apply(e){const t=this.getState(),r=Vi(e,this.attrItem,this.getState())
var n,i
